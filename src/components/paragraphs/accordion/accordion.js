	...
	open(skipTransition = false) {
		...
		transitionAuto({
			...
			onComplete: () => {
				this.state = 'opened';
				if (skipTransition) {
					let nothing = this.content.element.offsetWidth;
...
const transitionAuto = (function () {
	...
	function setValue(options) {
		...
		let nothing = options.element.offsetHeight; // This line does nothing but force the element to repaint so transitions work properly.
